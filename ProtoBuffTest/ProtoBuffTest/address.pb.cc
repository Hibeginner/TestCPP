...
static ::_pb::Metadata file_level_metadata_address_2eproto[3];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_address_2eproto[1];
...
const char descriptor_table_protodef_address_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\raddress.proto\022\010tutorial\"\333\001\n\006Person\022\014\n\004"
...
const ::_pbi::DescriptorTable descriptor_table_address_2eproto = {
    false, false, 296, descriptor_table_protodef_address_2eproto,
    "address.proto",
...
bool Person::IsInitialized() const {
  if (_Internal::MissingRequiredFields(_has_bits_)) return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(phones_))
    return false;
  return true;
}
...
bool AddressBook::IsInitialized() const {
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(people_))
    return false;
  return true;
}
